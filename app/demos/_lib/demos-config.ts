...
export const DEMOS: readonly DemoConfig[] = [
  ...
  },
  {
    ...
    tag: 'Auto',
    desc: 'No-nonsense auto shop with free quote assistant',
  },
  {
    slug: 'boutique-ropa',
    name: 'Maison Vera',
  ...
  {
    slug: 'contador',
    name: 'Nova Accounting',
    industry: 'Accounting Firm',
    emoji: '📊',
    color: 'from-zinc-900 to-green-800',
    tag: 'Finance',
    desc: 'Professional accounting site with tax FAQ chatbot',
  },
  {
    slug: 'fotografia',
    name: 'Marco Lens',
