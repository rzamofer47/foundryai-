/**
 * Scope Steelmark Auto CSS under #steelmark-root.
 */
const fs = require('fs')
const path = require('path')

const rootDir = path.join(__dirname, '..')
const cssPath = path.join(rootDir, 'html-originals', 'steelmark-auto-styles.css')
const outPath = path.join(rootDir, 'app', 'demos', 'taller-mecanico', 'scoped-style.css')

const PREFIX = '#steelmark-root'
...
const out = '/* Steelmark Auto — scoped for Next demo */\n' + header + '\n' + scopeBlock(css.trim()) + '\n'
