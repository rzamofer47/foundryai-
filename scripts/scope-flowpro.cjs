/**
 * Scope FlowPro Plumbing CSS under #flowpro-root.
 */
const fs = require('fs')
const path = require('path')

const rootDir = path.join(__dirname, '..')
const cssPath = path.join(rootDir, 'html-originals', 'flowpro-plumbing-styles.css')
const outPath = path.join(rootDir, 'app', 'demos', 'plomeria', 'scoped-style.css')

const PREFIX = '#flowpro-root'
...
const out = '/* FlowPro Plumbing — scoped for Next demo */\n' + header + '\n' + scopeBlock(css.trim()) + '\n'
