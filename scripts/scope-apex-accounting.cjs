/**
 * Scope Apex Accounting CSS under #apex-accounting-root.
 */
const fs = require('fs')
const path = require('path')

const rootDir = path.join(__dirname, '..')
const cssPath = path.join(rootDir, 'html-originals', 'apex-accounting-styles.css')
const outPath = path.join(rootDir, 'app', 'demos', 'contador', 'scoped-style.css')

const PREFIX = '#apex-accounting-root'
...
const out = '/* APEX ACCOUNTING — scoped for Next demo */\n' + header + '\n' + scopeBlock(css.trim()) + '\n'
