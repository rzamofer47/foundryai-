/**
 * Scope Meridian Accounting CSS under #meridian-root.
 */
const fs = require('fs')
const path = require('path')

const rootDir = path.join(__dirname, '..')
const cssPath = path.join(rootDir, 'html-originals', 'meridian-accounting-styles.css')
const outPath = path.join(rootDir, 'app', 'demos', 'contador', 'scoped-style.css')

const PREFIX = '#meridian-root'
...
const out = '/* Meridian Accounting — scoped for Next demo */\n' + header + '\n' + scopeBlock(css.trim()) + '\n'
